...
###################################################################
#
# LeeScheme makefile for OpenBSD
#
###################################################################
###################################################################
...
# flags, configuration
CONFIG_FLAGS = -Wall -ansi -D__GCC__ -DOPENBSD
#CONFIG_FLAGS = -g -Wall -ansi -D__GCC__ -DOPENBSD -DPOINTERS
...
#despite on-the-web info, the following is not as fast either of my athlons...
ATHLON_OPTIMIZATIONS = -s -O3 -fomit-frame-pointer -mpentiumpro -march=pentiumpro -malign-functions=4 -funroll-loops -fexpensive-optimizations -malign-double -fschedule-insns2 -mwide-multiply
